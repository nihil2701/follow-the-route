...
<style type="text/css" media="screen">
    ...
    canvas { background:url(images/level4.png) }
  </style>
...
<p align="center" id="p3" style="font-size: 23px; font-family:'EamesBookItalic','Georgia',serif; color: #3af9b5">G O O D &nbsp&nbspJ O B</p>
<a href="index.php"><img class="close_button_1" src="images/BackButton.gif" style="right:310px"/></a>
<a href="level5.php"><img class="close_button_2" src="images/nextlevel.png" style="right:100px"/></a>
...
$sql="SELECT * FROM level3 WHERE tek_emailid='$user'";
...
<script src="js/scriptAnumod4.js"></script>
</html>