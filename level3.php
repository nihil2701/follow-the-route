...
<html lang="en">
<head>
<title>Follow The Route _ LEVEL: 3</title>
</head>
...
<style type="text/css" media="screen">
    canvas, img { display:block; margin:1em auto; border:2px solid white; }
    canvas { background:url(images/level3.png) }
  </style>
...
<p align="center" id="p3" style="font-size: 23px; font-family:Algerian; color: #3af9b5">G O O D &nbsp&nbspJ O B</p>
<a href="index.php"><img class="close_button_1" src="images/BackButton.gif" style="right:310px"/></a>
<a href="level4.php"><img class="close_button_2" src="images/nextlevel.png" style="right:100px"/></a>
...
$sql="SELECT * FROM level2 WHERE tek_emailid='$user'";
...
<script src="js/scriptAnumod3.js"></script>
</html>