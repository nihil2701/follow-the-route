...
<style type="text/css" media="screen">
    canvas, img { display:block; margin:1em auto; border:1px solid white; }
    canvas { background:url(images/level2.png) }
  </style>
</head>
<body style="background:#141213">
...
<a href="level3.php"><img class="close_button_2" src="images/nextlevel.png" style="right:100px"/></a>
...
$sql="SELECT * FROM level1 WHERE tek_emailid='$user'";
...
<script src="js/scriptAnumod2.js"></script>
