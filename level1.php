...
<html lang="en">
<head>
<title>Follow The Route _ LEVEL: 1</title>
</head>
...
<style type="text/css" media="screen">
    ...
    canvas { background:url(images/level1.png) }
  </style>
<div> 	
...
<p align="center" id="p1" style="font-size: 20px; font-family:Algerian; color: red">
</p>
...
<p align="center" id="p2" style="font-size: 20px; font-family:Algerian; color: red">G A M E &nbsp&nbsp&nbsp O V E R<br>
</p>
...
<p align="center" id="p3"  style="font-size: 23px; font-family:Algerian; color: #3af9b5">G O O D &nbsp&nbspJ O B<br>
</p>
<a href="index.php"><img class="close_button_1" src="images/BackButton.gif" style="right:310px"/></a>
<a href="level2.php"><img class="close_button_2" src="images/nextlevel.png" style="right:100px"/></a>
...
<script src="js/scriptAnumod1.js"></script>
