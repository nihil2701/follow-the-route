  ...
  <div class="container_16 clearfix">
      ...
      <nav id="main_nav" class="bitter grid_9">
        <ul>
          ...
          <li class="active"><a href="3-control.php">Controls</a></li>
...
<section id="main">
  <div class="container_16 clearfix">
<br><br>
    <h2 class="luck grid_16">Controls</h2>

    <div class="clear"></div><div class="big_sep"></div><div class="clear"></div>

    <div class="grid_11 omega">
      <article>
        <div class="article_date luck grid_2 alpha omega"><span class="month"></span><span class="year">1.</span></div>
        <div class="grid_9 alpha">
          <h1 class="luck">Arrow keys for movement</h1>
          <p></p>
          <img src="css/images/placeholders/control.jpg" alt="" width="529" height="240"/>
          <span class="caption osans-i"></span>
          <p></p>
      ...
      <!--<article>
        <div class="article_date luck grid_2 alpha omega"><span class="month"></span><span class="year">2.</span></div>
        <div class="grid_9 alpha">
          <h1 class="luck">Drive to pick up.</h1>
          <p></p>
      ...
      <article>
        <div class="article_date luck grid_2 alpha omega"><span class="month"></span><span class="year">3.</span></div>
        <div class="grid_9 alpha">
          <h1 class="luck">Point to board a patient</h1>
          <p></p>
